...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // ============================================================
  // 1. Màu thiệp (Envelope Open Animation)
  // ============================================================
  openBtn.addEventListener('click', () => {
    // Pháº£i gá»i play() ngay trong gesture context Ä‘á»ƒ mobile khÃ´ng bá»‹ block autoplay
    bgMusic.volume = 0.4;
  ...
  function startAutoScroll() {
    ...
    // Dá»«ng khi ngÆ°á»i dÃ¹ng cuá»™n tay (wheel, touch, keyboard)
    ...
    const pixelsPerSecond = 60; // tá»‘c Ä‘á»™ cuá»™n: 60px/giÃ¢y (cháº­m, Ä‘á»u)
    ...
    function step(now) {
      ...
      const elapsed = (now - startTime) / 1000; // giÃ¢y
  ...
  // ============================================================
  // 2. NHáº C Ná»€N (Background Music)
  // ============================================================
  ...
  // ============================================================
  // 4b. GIFT AVATAR & QR â€” CLICK TO VIEW FULL IMAGE
  // ============================================================
  ...
  // ============================================================
  // 5. RSVP FORM â€” Gá»¬I Dá»® LIá»†U QUA LARAVEL API
  // ============================================================
  ...
  function onScroll() {
    // Hide song há»· when footer is reached
    if (footer) {
  ...
  // ============================================================
  // 9. HIá»†U á»¨NG HOA ANH ÄÃ€O RÆ I (Cherry Blossom Petals Canvas)
  // ============================================================
  ...
  class Petal {
    ...
    draw() {
      ...
      ctx.beginPath();
      // Váº½ cÃ¡nh hoa báº±ng 2 Ä‘Æ°á»ng cong bezier
      ctx.moveTo(0, 0);
      ctx.bezierCurveTo(
  ...
  // MÃ u phÃ¡o hoa thanh lá»‹ch, tone rose gold & pastel
  const FW_COLORS = [
  ...
  function launchRocket() {
    ...
    // Random next launch: 1200msâ€“2400ms
